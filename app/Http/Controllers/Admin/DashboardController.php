...
class DashboardController extends Controller
{
    public function index(){
    	...
    	return view('back.admin.dashboard',compact('students','teachers','parents','stdclasses','classe'));
    }

    public function profile(){
        $user=Auth::guard('admin')->user();
        return view('back.admin.profile.view', compact('user'));
    }
    ...
    public function edit($id=null){
        ...
        $user=Auth::guard('admin')->user();
        return view('back.admin.profile.edit', compact('user'));
    }
    public function createuser(){
        return view('back.admin.profile.create');
    }
    ...
    public function allusers(){
        ...
        return view('back.admin.profile.index', compact('users'));
    }
}
