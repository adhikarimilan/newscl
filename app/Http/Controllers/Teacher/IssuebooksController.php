...
class IssuebooksController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('back.teacher.bookissues.index',compact('bookissues'));
    }
    ...
    public function create()
    {
        ...
        return view('back.teacher.bookissues.create',compact('books','classes'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $link=route('teacher.bookissues.show',['bookissue'=>$input->id]);
