...
class StudentattendanceController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('back.teacher.sattendance.show')->with(['statuserr'=>'please select class','classes'=>$classes]);
        ...
        return view('back.teacher.sattendance.show')->with(['students'=>$students,'classes'=>$classes,'reqdate'=>$reqdate,'d'=>$d]);
    }
    ...
    public function create()
    {
        ...
        return view('back.teacher.sattendance.create')->with(['error'=>'please select class','classes'=>$classes]);
        ...
        return view('back.teacher.sattendance.view')->with(['success'=>$success,'students'=>$students,'classes'=>$classes]);
        }
...
//         dd($attendances);
       ...
       // $students = Student::where('active','1')->orderBy('roll_no')->get();
        return view('back.teacher.sattendance.create',compact('students','classes'));
    }
    ...
    public function edit($studentattendance)
    {
        ...
        //$teachers=Teacher::where('active','1')->orderBy('order')->get();
        $students=$students->where('active','1')->orderBy('roll_no')->get();
        return view('back.teacher.sattendance.edit',compact('students'));
    }
