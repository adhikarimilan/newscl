...
class TeacherController extends Controller
{
    ...
    public function index()
    {
       ...
       // $teachers=[];
        return view('back.teacher.teacher.index', compact('teachers'));
    }
    ...
    public function show($id)
    {
        ...
        return view('back.teacher.teacher.view', compact('teacher'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $link=route('teacher.profile');
        return redirect()->back()->with(['success'=> 'Your account info updated successfully','link'=>$link]);
    }
