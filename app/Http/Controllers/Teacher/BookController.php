...
class BookController extends Controller
{
    ...
    {
        $books=Book::get();
        return view('back.teacher.books.index',compact('books'));
    }
    ...
    public function create()
    {
        ...
        return view('back.teacher.books.create',compact('categories'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $link=route('teacher.books.show',['book'=>$input->id]);
    ...
    public function show($id)
    {
        ...
        return view('back.teacher.books.view',compact('book'));
    }
    ...
    public function edit($id)
    {
        $book=Book::findOrFail($id);
        $categories=Bookcategories::get();
        return view('back.teacher.books.edit',compact('categories','book'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $link=route('teacher.books.show',['book'=>$book->id]);
