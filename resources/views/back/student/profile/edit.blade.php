    ...
    <div class="">
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12">
          <div class="x_panel">
            <div class="x_title">
              <h2>Edit Your Profile::{{$student->name}}</h2>
            ...
            <div class="x_content">
                @include('msg.msg')
              <form action="{{route('student.profile.update',['id'=>$student->id])}}" method="post" class="" enctype="multipart/form-data">
                @csrf
                {{method_field('put')}}
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="text" id="name" name="name" placeholder="Studentname"  class="form-control" value="{{$student->name}}" required>
                    </div>
                </div>
                <div class="form-group">
                    <div class="input-group">
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="text" id="tempaddress" name="temp_address" placeholder="Temporary Address" class="form-control" value="{{$student->temp_address}}" required>
                    </div>
                </div>
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="text" id="peraddress" name="per_address" placeholder="Permanent address" class="form-control" value="{{$student->per_address}}" required>
                    </div>
                </div>
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="dob_bs" placeholder="yyyy-mm-dd (bs)" value="{{$student->dob_bs}}">
                    </div>
                </div>
                <div class="form-group">
                  <div class="input-group">
                      ...
                      <input type='text' class="form-control"  name='dob_ad' placeholder="yyyy-mm-dd (ad)" value="{{$student->dob_ad}}"/>
                  </div>
              </div>
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="text" id="contact" name="contact" placeholder="Contact Number" class="form-control" value="{{$student->contact}}" required>
                    </div>
                </div>
                <div class="form-group">
                  <div class="input-group">
                      <div class="input-group-addon" data-toggle="tooltip" data-placement="right"  data-original-title="Your Bio"><i class="fa fa-comment"></i></div>
                      <input type="text" id="bio" name="bio" placeholder="Contact Number" class="form-control" value="{{$student->bio}}" required>
                  </div>
              </div>
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="email" id="email" name="email" placeholder="Email" class="form-control" value="{{$student->email}}" required>
                    </div>
                </div>
