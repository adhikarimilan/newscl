...
<div class="col-md-12 col-sm-12 ">
  <div class="x_panel">
    <div class="x_title">
      <h2><strong class="card-title">All Assignments of {{$student->name}}</strong>
        </h2>
    ...
    <div class="x_content">
      ...
      <tbody>
        @if ($student->class && $assignments=$student->class->assignments)
      ...
      @foreach ($assignments as $assignment)
          <tr>
            <th class="d-none">&nbsp;</th>
              ...
              <td><a class="btn btn-info" href="{{route('parent.assignment.view',['id'=>$assignment->id])}}"><i class="fa fa-eye"></i></a>
              <a class="btn btn-primary" href="{{route('parent.assignment.view',['id'=>$assignment->id])}}"><i class="fa fa-edit"></i></a>
