...
<div class="col-md-12 col-sm-12 ">
  <div class="x_panel">
    <div class="x_title">
      <h2><strong class="card-title">All Users</strong>
        </h2>
        <a href="{{route('admin.users.create')}}" class="btn btn-success pull-right btn-sm">Add New User</a>
    ...
    <div class="x_content">
      ...
      @foreach ($users as $user)
          <tr>
              <td>
                @if($user->avatar)
                <img src="{{asset($user->avatar)}}" alt="" style="width:90px;">
              @else 
              ...
              {{-- hrdef="{{route('users.show',['user'=>$user->id])}}" --}}
              <td><a class="btn btn-info"   href="#"><i class="fa fa-eye"></i></a>
              <a class="btn btn-primary" href="{{route('admin.profile.edit',['id'=>$user->id])}}"><i class="fa fa-edit"></i></a>
                <a class="btn btn-danger" onclick="document.getElementById('{{'delete-form-'.$user->id}}').submit();"><i class="fa fa-trash"></i></a>
                <form action="{{route('admin.users.destroy',['id'=>$user->id])}}" id="{{'delete-form-'.$user->id}}" method="post">
