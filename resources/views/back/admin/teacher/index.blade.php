    ...
    <div class="x_content">
      ...
      @foreach ($teachers as $teacher)
          <tr>
              ...
              <td><a class="btn btn-info" href="{{route('teachers.show',['teacher'=>$teacher->id])}}"><i class="fa fa-eye"></i></a>
              <a class="btn btn-primary" href="{{route('teachers.edit',['teacher'=>$teacher->id])}}"><i class="fa fa-edit"></i></a>
                <a class="btn btn-danger"  onclick="document.getElementById('{{'delete-form-'.$teacher->id}}').submit();"><i class="fa fa-trash"></i></a>
                <form action="{{route('teachers.destroy',['teacher'=>$teacher->id])}}" id="{{'delete-form-'.$teacher->id}}" method="post">
