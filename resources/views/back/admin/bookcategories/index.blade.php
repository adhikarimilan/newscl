    ...
    <div class="x_content">
      ...
      @foreach ($categories as $category)
          <tr>
              ...
              <td><a class="btn btn-info" href="{{route('bookcategories.show',['bookcategory'=>$category->id])}}"><i class="fa fa-eye"></i></a>
              <a class="btn btn-primary" href="{{route('bookcategories.edit',['bookcategory'=>$category->id])}}"><i class="fa fa-edit"></i></a>
                <a class="btn btn-danger"  onclick="document.getElementById('{{'delete-form-'.$category->id}}').submit();"><i class="fa fa-trash"></i></a>
                <form action="{{route('bookcategories.destroy',['bookcategory'=>$category->id])}}" id="{{'delete-form-'.$category->id}}" method="post">
...
<div class="x_panel">
  ...
  <div class="x_content">
      ...
      <form action="{{route('bookcategories.store')}}" method="post" class="">
          @csrf
