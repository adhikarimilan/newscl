...
<div class="col-md-12 col-sm-12 ">
  <div class="x_panel">
    <div class="x_title">
      ...
      <a href="{{route('books.create')}}" class="btn btn-success pull-right btn-sm">Add New Book</a>
    ...
    <div class="x_content">
      ...
      @foreach ($books as $book)
          <tr>
              ...
              <td><a class="btn btn-info" href="{{route('books.show',['book'=>$book->id])}}"><i class="fa fa-eye"></i></a>
              <a class="btn btn-primary" href="{{route('books.edit',['book'=>$book->id])}}"><i class="fa fa-edit"></i></a>
                <a class="btn btn-danger"  onclick="document.getElementById('{{'delete-form-'.$book->id}}').submit();"><i class="fa fa-trash"></i></a>
                <form action="{{route('books.destroy',['book'=>$book->id])}}" id="{{'delete-form-'.$book->id}}" method="post">
