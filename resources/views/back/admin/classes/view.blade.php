            ...
            <div class="x_content">
              ...
              @foreach ($class->students as $student)
                  <tr>
                      ...
                      <td><a class="btn btn-info" href="{{route('students.show',['student'=>$student->id])}}"><i class="fa fa-eye"></i></a>
                      <a class="btn btn-primary" href="{{route('students.edit',['student'=>$student->id])}}"><i class="fa fa-edit"></i></a>
                        <a class="btn btn-danger" onclick="document.getElementById('{{'delete-form-'.$student->id}}').submit();"><i class="fa fa-trash"></i></a>
                        <form action="{{route('students.destroy',['student'=>$student->id])}}" id="{{'delete-form-'.$student->id}}" method="post">
