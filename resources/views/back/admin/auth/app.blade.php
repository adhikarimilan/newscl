        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="{{route('admin.dashboard')}}" title="Dashboard"> <i class="menu-icon fa fa-dashboard"></i>Dashboard </a>
                    </li>
                    <h3 class="menu-title">elements</h3><!-- /.menu-title -->
                    <li class="menu-item-has-children dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="Teachers"> <i class="menu-icon fa fa-laptop" ></i>Teachers</a>
                        <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-plus"></i><a href="{{route('teachers.create')}}">Add New</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="{{route('teachers.index')}}">All Teachers</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="Teachers"> <i class="menu-icon fa fa-laptop" ></i>Classes</a>
                            <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-plus"></i><a href="{{route('classes.create')}}">Add New</a></li>
                                <li><i class="fa fa-id-badge"></i><a href="{{route('classes.index')}}">All Classes</a></li>
                            </ul>
                        </li>
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-table"></i><a href="{{route('students.create')}}">Add New</a></li>
                            <li><i class="fa fa-table"></i><a href="{{route('students.index')}}">All Students</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-th"></i>Attendence</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-th"></i><a href="{{route('tattendance.index')}}">Teacher's Attendence</a></li>
                            <li><i class="menu-icon fa fa-th"></i><a href="{{route('cattendance.index')}}">Class's Attendance</a></li>
                        </ul>
                    </li>
                    ...
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            @for($i = 2; $i <= count(Request::segments()); $i++)
                              <li>
                                 <a class="active-trail current" href="{{ URL::to( implode( '/', array_slice(Request::segments(), 0 ,$i, true)))}}">
