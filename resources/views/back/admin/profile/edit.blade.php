      ...
      <div class="row">
        <div class="col-md-12 col-sm-12">
          <div class="x_panel">
            ...
            <div class="x_content">
                @include('msg.msg')
                <form action="{{route('admin.profile.update',['id'=>$user->id])}}" method="post" class="" id='std-form' enctype="multipart/form-data">
                    @csrf
                    {{-- {{method_field('put')}} --}}
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="text" id="name" name="name" placeholder="Username" class="form-control" value="{{$user->name}}" required title="User Name">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="radio" id="male" name="gender"  class="form-" value="0" @if ($user->gender=='0')
                            checked 
                          @endif required title='Gender: Male'>
                            ...
                            <input type="radio" id="female" name="gender"  class="form-" value="1" @if ($user->gender=='1')
                            checked 
                          @endif title='Gender: Female'>
                            ...
                            <input type="radio" id="other" name="gender"  class="form-" value="2" @if ($user->gender==2)
                            checked 
                          @endif 
                           @if ($user->gender===null)
                          checked 
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="text" id="email" name="email" placeholder="Email" class="form-control" value="{{$user->email}}" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <select name="active" id="status" class="form-control" required>
                                <option value="1" @if ($user->active=='1')
                                  selected  
                                @endif>Active</option>
                                <option value="0" @if ($user->active=='0')
                                selected  
