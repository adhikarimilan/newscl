...
<div class="col-md-12 col-sm-12 ">
  <div class="x_panel">
    <div class="x_title">
      <h2><strong class="card-title">All Events</strong>
        </h2>
        <a href="{{route('events.create')}}" class="btn btn-success pull-right btn-sm">Add New Event</a>
    ...
    <div class="x_content">
      ...
      @foreach ($events as $event)
          <tr>
              <td>
                @if($event->pic)
                <img src="{{asset($event->pic)}}" alt="" style="width:90px;">
              @else 
              ...
              <a class="btn btn-primary" href="{{route('events.edit',['event'=>$event->id])}}"><i class="fa fa-edit"></i></a>
                ...
                <form action="{{route('events.destroy',['event'=>$event->id])}}" id="{{'delete-form-'.$event->id}}" method="post">
