        ...
        <div class="col-md-12 col-sm-12">
          <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <form action="{{route('teacher.parents.store')}}" method="post" class="" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="text" id="name" name="name" placeholder="Parent name" class="form-control" value="{{old('name')}}" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="text" id="occupation" name="occupation" placeholder="Occupation" class="form-control" value="{{old('occupation')}}" >
                    </div>
                </div>
                ...
                {{-- student addition --}}
                <h4 class="text-dark mt-2">Add Student</h4>
                <form action="#" method="post" id="stdform" style="display: none;">
                  <div id="student-sel">
                  <div id="std-1" >
...
function searchstd(id){
        let num=id;
          ...
          if(iid!=cval){
            $('#section-choose-def-'+ num).hide();
            let url="{{route('teacher.classes.getstudents')}}";
            let cid=cval;
