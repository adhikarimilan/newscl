      ...
      <div class="row">
        <div class="col-md-12 col-sm-12">
          <div class="x_panel">
            ...
            <div class="x_content">
                @include('msg.msg')
                <form action="{{route('teacher.parents.update',['parent'=>$parent->id])}}" method="post" class="" id='std-form' enctype="multipart/form-data">
                    @csrf
                    {{method_field('put')}}
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <option value="{{$class->id}}" @if ($parent->class_id===$class->id)
                                  selected  
                    ...
                    <div id="sections">
                    @if($parent->class && $parent->class->sections)
                        ...
                        <div class="input-group">
                            ...
                            <select name="section" id="section" class="form-control" title="Choose Section">
                                <option value="">Choose Section</option>
                                 @foreach ($parent->class->sections as $section)
                            <option value="{{$section->id}}" @if ($parent->section_id===$section->id)
                                  selected  
                ...
                <form action="{{route('teacher.parents.updatechildren')}}" method="post" id="stdform">
