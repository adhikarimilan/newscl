  ...
  <div class="x_panel">
    <div class="x_title">
      <h2><strong class="card-title">All Parents</strong>
        ...
        <a href="{{route('teacher.parents.create')}}" class="btn btn-success pull-right btn-sm">Add New Parent</a>
    ...
    <div class="x_content">
      ...
      @foreach ($parents as $parent)
          <tr>
              ...
              <td><a class="btn btn-info"  href="{{route('teacher.parents.show',['parent'=>$parent->id])}}"><i class="fa fa-eye"></i></a>
              <a class="btn btn-primary" href="{{route('teacher.parents.edit',['parent'=>$parent->id])}}"><i class="fa fa-edit"></i></a>
                <a class="btn btn-danger" onclick="document.getElementById('{{'delete-form-'.$parent->id}}').submit();"><i class="fa fa-trash"></i></a>
                <form action="{{route('teacher.parents.destroy',['parent'=>$parent->id])}}" id="{{'delete-form-'.$parent->id}}" method="post">
