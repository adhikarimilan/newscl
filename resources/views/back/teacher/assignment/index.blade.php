...
<div class="col-md-12 col-sm-12 ">
  <div class="x_panel">
    <div class="x_title">
      <h2><strong class="card-title">All Assignments</strong>
        </h2>
        <a href="{{route('teacher.assignments.create')}}" class="btn btn-success pull-right btn-sm">Add New Assignment</a>
      ...
      @foreach ($assignments as $assignment)
          <tr>
            <th class="d-none">&nbsp;</th>
              ...
              @if ($assignment->teacher->id == Auth::guard('teacher')->user()->id)
                (You)  
              @endif
              </td>
            ...
            @endphp</td>
              ...
              <td><a class="btn btn-info" href="{{route('teacher.assignments.show',['assignment'=>$assignment->id])}}"><i class="fa fa-eye"></i></a>
              <a class="btn btn-primary" href="{{route('teacher.assignments.edit',['assignment'=>$assignment->id])}}"><i class="fa fa-edit"></i></a>
                <a class="btn btn-danger" onclick="document.getElementById('{{'delete-form-'.$assignment->id}}').submit();"><i class="fa fa-trash"></i></a>
                <form action="{{route('teacher.assignments.destroy',['assignment'=>$assignment->id])}}" id="{{'delete-form-'.$assignment->id}}" method="post">
